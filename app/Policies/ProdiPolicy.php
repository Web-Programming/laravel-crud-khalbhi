...
class ProdiPolicy
{
    ...
    {
        //return $user->email === "agung@gmail.com" || $user->email === "ekke@gmail.com";

        $arruser = ['agung@gmail.com', 'ekke@gmail.com'];
        return in_array($user->email, $arruser);
    }
    ...
    {
        return $user->email === "agung@gmail.com";
    }
    ...
    {
        return $user->email === "ekke@gmail.com";
    }
